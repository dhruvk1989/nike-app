...
import {shoes, statistics} from '../constands'
    ...
    <section id='home' 
      ...
      justify-center min-h-screen gap-10 max-container'>
        ...
        pt-28'>
          ...
          text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>Discover Stylish Nike arrivals, quality comfort, and innovation for your active life.</p>
        ...
        items-center flex-1 xl:min-h-screen
